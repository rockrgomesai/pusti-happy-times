/**
 * Add DO List features to Distribution role
 * - Menu items (DO List, My DO List)
 * - API permissions (do-list:read, my-do-list:read, etc.)
 *
 * Usage: node add-distribution-do-features.js
 */
...
const main = async () => {
  try {
    ...
    console.log("\n=== Adding DO Features to Distribution Role ===\n");
    ...
    console.log(`✓ Found Distribution role`);
    console.log(`  ID: ${distributionRole._id}`);
    console.log(`  Name: ${distributionRole.name || distributionRole.role}\n`);
    ...
    console.log("\n✓ Distribution DO features setup complete!\n");
