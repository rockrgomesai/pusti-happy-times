...
const main = async () => {
  try {
    ...
    console.log("\n=== Adding DO Features to Finance Role ===\n");
    ...
    console.log(`✓ Found Finance role`);
    console.log(`  ID: ${financeRole._id}`);
    console.log(`  Name: ${financeRole.name || financeRole.role}\n`);
    ...
    console.log("\n✓ Finance DO features setup complete!\n");
