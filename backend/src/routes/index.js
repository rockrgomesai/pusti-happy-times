...
const approvedReqSchedulesRoutes = require("./inventory/approved-req-schedules");
const reqLoadSheetsRoutes = require("./inventory/req-load-sheets");
const reqChalansRoutes = require("./inventory/req-chalans");
...
/**
 * Distributor Type Management Routes
 * @route   /api/distributor-types/*
 * @desc    Distributor type master data CRUD operations
...
router.use("/inventory/approved-req-schedules", approvedReqSchedulesRoutes);
router.use("/inventory/req-load-sheets", reqLoadSheetsRoutes);
router.use("/inventory/req-chalans", reqChalansRoutes);
